...
unless EnumResource.any?
  ...
  EnumResource.create(name: "Меню \"Заявки\"", resource_name: "menu_order", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Контрольные карточки\"", resource_name: "menu_task", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Структурное подразделения\"", resource_name: "menu_structural", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Торговые объекты\"", resource_name: "menu_shop", enum_action_id: 2)
  EnumResource.create(name: "Меню \"ЭЦП\"", resource_name: "menu_esp", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Сервисное обслуживания\"", resource_name: "menu_service", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Отчеты\"", resource_name: "menu_report", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Сотрудники\"", resource_name: "menu_employee", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Справочники\"", resource_name: "catalog", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Настройка доступа к системе\"", resource_name: "menu_access", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Пользователи системы\"", resource_name: "menu_user_access", enum_action_id: 2)
  EnumResource.create(name: "Меню \"Шаблон доступа\"", resource_name: "menu_templates_access", enum_action_id: 2)
end
