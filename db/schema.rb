...
ActiveRecord::Schema.define(version: 2019_09_26_092640) do
  ...
  create_table "sim_cards", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "traffic", default: 0, null: false
    t.datetime "update_traffic"
    t.index ["provider_id"], name: "index_sim_cards_on_provider_id"
  end

  create_table "sim_logs", force: :cascade do |t|
    t.bigint "sim_card_id", default: 0, null: false
    t.bigint "shop_id", default: 0, null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_id"], name: "index_sim_logs_on_shop_id"
    t.index ["sim_card_id"], name: "index_sim_logs_on_sim_card_id"
  end
  ...
  create_table "task_executions", force: :cascade do |t|
    ...
    t.string "comment", default: "", null: false
    t.integer "task_execution", default: 0, null: false
    t.datetime "completed"
  ...
  create_table "task_performers", force: :cascade do |t|
  ...
  create_table "task_reworks", force: :cascade do |t|
    t.bigint "task_execution_id", default: 0, null: false
    t.bigint "user_id", default: 0, null: false
    t.string "comment", default: "", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["task_execution_id"], name: "index_task_reworks_on_task_execution_id"
    t.index ["user_id"], name: "index_task_reworks_on_user_id"
  end

  create_table "tasks", force: :cascade do |t|
    t.bigint "type_document_id", default: 0, null: false
    t.string "task_number", default: "", null: false
    t.bigint "structural_id", default: 0, null: false
    t.datetime "date_open", null: false
